...
2. Заполнение поля цифрами
3. Заполнение поля невалидными знаками - )*? и т.д.
4. Заполнение поля одной буквой
5. Заполнение поля более чем 100 символами
6. Заполнение поля с использованием двойной фамилии с дефисом
7. Незаполненное поле
##### Поле "CVC/CVV"
...
2. Тестирование кнопки "Купить"
3. Тестирование кнопки "Купить в кредит"
